...
def get_performance_status(portfolio_id, asset_id, status_date=None):
    cte_dates = (
        select(
            ...
            (
                func.lag(PortfolioAssetPerformance.date).over(
                    order_by=PortfolioAssetPerformance.date.asc()
                )
            ).label("previous_date"),
            func.max(PortfolioAssetPerformance.date).over().label("max_date"),
        ).where(
            and_(
    ...
    curr_perf = aliased(PortfolioAssetPerformance, name="curr_perf")
    prev_perf = aliased(PortfolioAssetPerformance, name="prev_perf")
    ...
    query = (
        ...
        .join_from(
            ...
            and_(
                ...
                curr_perf.asset_id == cte_status_dates.c.asset_id,
        ...
        .join(
            ...
            and_(
                ...
                prev_perf.asset_id == cte_status_dates.c.asset_id,
